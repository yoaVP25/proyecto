	...
	<main class="main">
		<div class="contenedor2">
			<div class="table">
				...
				<div class="titulos agre"><button class="agregar">Agregar</button></div>
				<?php 
					$query="SELECT nombre,apellido,usuario,matricula FROM usuarios WHERE id_rol=2";
